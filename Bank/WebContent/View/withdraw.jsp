	...
	$(".d").click(function()
	{
		...
		if(accno=="" || amt=="")
		{
			...
			{	//alert(accno+amt+inamt);
				$.getJSON("../ActionPage/withdrawAction.jsp?&accno="+accno,"&amt="+amt,function(data)
						{
							var message=data[0].result;
							//alert(message);
							if(message=="success")
								{
								alert("SUCESSFULLY WITHDRAWED!");
...
<body>
	<div class="a"> <h4><center> WITHDRAW FORM</center></h4>
		<div class="b">
		...
		<div class="d">
			<input type="button" value="Withdraw" class="button">
		</div>
